...
require (
	...
	github.com/yandex-cloud/go-genproto v0.0.0-20240919115538-c1956ccf891c // indirect
...
replace github.com/onsi/ginkgo/v2 => github.com/onsi/ginkgo/v2 v2.16.0

replace github.com/onsi/gomega => github.com/onsi/gomega v1.31.1
